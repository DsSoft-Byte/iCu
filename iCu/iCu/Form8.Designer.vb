...
Partial Class Form8
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label1.Text = "iCu Troubleshooting information "
        '
        'Label2
        '
        ...
        Me.Label2.Text = "If you have not been told to be here by staff, you have no reason to be here. Thi" &
    "s info is useless for you."
        '
        'Panel1
        '
        ...
        Me.Panel1.Location = New System.Drawing.Point(17, 113)
        ...
        Me.Label12.Text = "BETABRANCH: PARTIALLEGACY"
        '
        'Label11
        '
        ...
        Me.Label11.Text = "NEW-S: TRUE-LEGACY-BETA"
        '
        'Label10
        '
        ...
        Me.Label10.Text = "DsSoft L1: unsupported"
        '
        'Label9
        '
        ...
        Me.Label9.Text = "INSTALLERMODE: OTA + EXEC"
        '
        'Label8
        '
        ...
        Me.Label6.Text = "PRELAUNCHER: 3.4.0"
        '
        'Label5
        '
        ...
        Me.Name = "Form8"
        Me.Text = "Information/Troubleshooting "
